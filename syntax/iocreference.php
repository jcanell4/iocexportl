    ...
    */
    function render($mode, Doku_Renderer $renderer, $data) {
        ...
        elseif($mode === 'wikiiocmodel_ptxhtml'){
            $match = preg_replace('/(:figure:)([^:]+)(:)/','<span class="figref"><a href="#$2"><span class=refType>figura</span><span class=refId> $2</span></a></span>',$data, 1);
            $match = preg_replace('/(:table:)([^:]+)(:)/','<span class="tabref"><a href="#$2"><span class=refType>taula</span><span class=refId> $2</span></a></span>',$match, 1);
            $renderer->doc .= $match;
            return TRUE;
        }
        return FALSE;
